...
실험 데이터는 항상 노이즈를 포함합니다. **Curve Fitting**은 노이즈가 섞인 데이터에서 원래 함수의 파라미터를 추정하는 방법입니다. SciPy의 `curve_fit()`을 사용하면 다양한 함수 꼴에 대해 피팅을 수행할 수 있습니다.
